...
VAL_DATA_ROOT    = None  # None = dùng data_root trong config (OEM_v2_Building)
VAL_SPLIT_FILE   = '/home/ubuntu/vy/Denoiser/OEM_v2_Building/val.txt'  # Override split (218 ảnh)
