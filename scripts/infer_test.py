...
CHECKPOINT       = osp.join(ROOT_DIR, 'work_dirs/exp8_all/best_model3.pth')
...
UNC_THRESHOLD    = 0.9          # pixel có unc_map > ngưỡng này → cần sửa (giống RandomCropAll train)
MAX_LOCAL_PATCHES = 48          # số patch tối đa mỗi ảnh
NMS_IOU_THR      = 0.5          # NMS IoU threshold để lọc patch chồng lấp
