"""
Exp 7: Boundary + Uncertainty
- Giống hệt Exp 8 nhưng tắt use_obj
"""
...
model = dict(
    ...
    diffusion_cfg=dict(
        ...
        noise_components=dict(use_obj=False, use_bnd=True, use_unc=True)
    ),
...
data = dict(
    train=dict(pipeline=[
        ...
        dict(type='LoadOEMCoarseMasks', use_obj=False, use_bnd=True, use_unc=True, test_mode=False),
