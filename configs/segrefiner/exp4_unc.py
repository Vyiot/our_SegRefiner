"""
Exp 4: Uncertainty Only
- Giống hệt Exp 8 nhưng chỉ bật use_unc
"""
...
model = dict(
    ...
    diffusion_cfg=dict(
        ...
        noise_components=dict(use_obj=False, use_bnd=False, use_unc=True)
    ),
...
data = dict(
    train=dict(pipeline=[
        ...
        dict(type='LoadOEMCoarseMasks', use_obj=False, use_bnd=False, use_unc=True, test_mode=False),
