"""
Exp 2: Object Only
- Chỉ dùng M_obj (xóa building theo object uncertainty)
- T=6 timesteps
"""
...
model = dict(
    ...
    diffusion_cfg=dict(
        ...
        noise_components=dict(use_m_obj=True, use_m_unc=False, use_modify_bnd=False)
    ),
...
data = dict(
    train=dict(pipeline=[
        ...
        dict(type='LoadOEMCoarseMasks', use_obj=True, use_unc=False, test_mode=False),
